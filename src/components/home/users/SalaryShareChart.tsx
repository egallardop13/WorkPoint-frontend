...
interface SalaryShareChartProps {
  userSalary: number
  departmentTotalSalary: number
  userFirstName: string
}

const SalaryShareChart = ({ userSalary, departmentTotalSalary, userFirstName }: SalaryShareChartProps) => {
  ...
  const userSharePercentage = Number(((userSalary / departmentTotalSalary) * 100).toFixed(1))
