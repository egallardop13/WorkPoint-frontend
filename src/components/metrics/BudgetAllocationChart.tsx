...
interface DepartmentProgressBar {
  departmentName: string
  departmentBudgetShare: string
...
interface BudgetAllocationChartProps {
  departments: DepartmentProgressBar[]
  pieChartData: PieChartDataEntry
}

export default function BudgetAllocationChart({ departments, pieChartData }: BudgetAllocationChartProps) {
              ...
              <Stack key={index} direction="row" sx={{ alignItems: 'center', gap: 2, pb: 2 }}>
                ...
                <Stack sx={{ gap: 1, flexGrow: 1 }}>
                  ...
                  <LinearProgress
                    ...
                    value={Number(department.departmentBudgetShare)}
                    sx={{
